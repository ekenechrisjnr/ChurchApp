...
void main() {
  test('fetchStream caches the response and avoids duplicate API calls', () async {
    int requestCount = 0;
    ...
    await fetchStream(client: mockClient);
    expect(requestCount, 1, reason: 'Second call should use cache and not hit the network');
